...
export default function Diagnostic() {
  ...
  const MOCK_QUESTIONS = Array(totalQuestions).fill(null).map((_, i) => ({
    id: i,
    text: `Given the current OPSC patterns, which logic follows the sequence correctly?`,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollBody}>
        ...
        <Text style={styles.questionTitle}>Question: {currentQuestion.id+1}</Text>
...
const styles = StyleSheet.create({
  ...
  questionTitle: { fontSize: 22, fontWeight: '800', color: '#0a1ef3', lineHeight: 30, marginBottom: 10 },
